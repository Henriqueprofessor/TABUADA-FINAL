...
const CONTEUDO_TUTORIAL_ALUNO = {
  objetivo: `<h3>🎯 Seja o grande campeão da Copa Tabuada CEIB 2026!</h3>
    ...
    <div style="text-align: center; margin: 20px 0;">
      <a href="./" target="_blank" style="display: inline-block; background: #27ae60; color: white; padding: 15px 40px; border-radius: 50px; text-decoration: none; font-weight: bold; font-size: 20px; transition: 0.2s;">🎮 Ir para o Jogo</a>
    </div>`,
