...
export async function renderizarRanking(fase, containerId, tipo = 'individual', exibirClassificacao = false) {
  ...
  // Buscar status de progresso (em jogo, finalizado)
  ...
  // Construir lista com dados adicionais
  let listaComInfo = ranking.map(j => {
    ...
    return {
      ...
      ultimaPosicao: null // será preenchido depois
    };
  });

  // Ordenar novamente (já está ordenado pelo calcularRankingFase)
  // Preencher última posição (se houver)
  ...
  // Calcular projeção de posição (se em andamento)
  ...
  for (let idx = 0; idx < listaComInfo.length; idx++) {
    ...
    // Melhor pontuação com partida (para professor)
...
// ============================================================
// ATUALIZAR INFORMAÇÕES DO ALUNO (BOLINHA, POSIÇÃO)
// ============================================================
...
// ============================================================
// FUNÇÕES DE CONTROLE DE FASE (AVANÇAR, RESETAR)
// ============================================================
...
// ============================================================
// FUNÇÕES DE PONTUAÇÃO (RANKING DE PONTOS)
// ============================================================
...
// ============================================================
// FUNÇÕES AUXILIARES DE UI (LISTAS, CONFIGURAÇÕES)
// ============================================================
